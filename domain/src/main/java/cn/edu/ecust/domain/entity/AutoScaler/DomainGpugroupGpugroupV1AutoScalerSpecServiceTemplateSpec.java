...
public class DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec {
  ...
  private List<DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecPorts> ports = null;
  ...
  private DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecSessionAffinityConfig sessionAffinityConfig;
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec allocateLoadBalancerNodePorts(Boolean allocateLoadBalancerNodePorts) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec clusterIP(String clusterIP) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec clusterIPs(List<String> clusterIPs) {
    
    this.clusterIPs = clusterIPs;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec addClusterIPsItem(String clusterIPsItem) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec externalIPs(List<String> externalIPs) {
    
    this.externalIPs = externalIPs;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec addExternalIPsItem(String externalIPsItem) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec externalName(String externalName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "externalName is the external reference that discovery mechanisms will return as an alias for this service (e.g. a DNS CNAME record). No proxying will be involved.  Must be a lowercase RFC-1123 hostname (https://tools.ietf.org/html/rfc1123) and requires Type to be")
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec externalTrafficPolicy(String externalTrafficPolicy) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec healthCheckNodePort(Integer healthCheckNodePort) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec ipFamilies(List<String> ipFamilies) {
    
    this.ipFamilies = ipFamilies;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec addIpFamiliesItem(String ipFamiliesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "IPFamilies is a list of IP families (e.g. IPv4, IPv6) assigned to this service, and is gated by the \"IPv6DualStack\" feature gate.  This field is usually assigned automatically based on cluster configuration and the ipFamilyPolicy field. If this field is specified manually, the requested family is available in the cluster, and ipFamilyPolicy allows it, it will be used; otherwise creation of the service will fail.  This field is conditionally mutable: it allows for adding or removing a secondary IP family, but it does not allow changing the primary IP family of the Service.  Valid values are \"IPv4\" and \"IPv6\".  This field only applies to Services of types ClusterIP, NodePort, and LoadBalancer, and does apply to \"headless\" services.  This field will be wiped when updating a Service to type ExternalName.   This field may hold a maximum of two entries (dual-stack families, in either order).  These families must correspond to the values of the clusterIPs field, if specified. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field.")
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec ipFamilyPolicy(String ipFamilyPolicy) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "IPFamilyPolicy represents the dual-stack-ness requested or required by this Service, and is gated by the \"IPv6DualStack\" feature gate.  If there is no value provided, then this field will be set to SingleStack. Services can be \"SingleStack\" (a single IP family), \"PreferDualStack\" (two IP families on dual-stack configured clusters or a single IP family on single-stack clusters), or \"RequireDualStack\" (two IP families on dual-stack configured clusters, otherwise fail). The ipFamilies and clusterIPs fields depend on the value of this field.  This field will be wiped when updating a service to type ExternalName.")
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec loadBalancerIP(String loadBalancerIP) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec loadBalancerSourceRanges(List<String> loadBalancerSourceRanges) {
    
    this.loadBalancerSourceRanges = loadBalancerSourceRanges;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec addLoadBalancerSourceRangesItem(String loadBalancerSourceRangesItem) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec ports(List<DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecPorts> ports) {
    
    this.ports = ports;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec addPortsItem(DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecPorts portsItem) {
    if (this.ports == null) {
      this.ports = new ArrayList<DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecPorts>();
    }
  ...
  **/
  ...
  public List<DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecPorts> getPorts() {
    return ports;
  }


  public void setPorts(List<DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecPorts> ports) {
    this.ports = ports;
  }


  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec publishNotReadyAddresses(Boolean publishNotReadyAddresses) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec selector(Map<String, String> selector) {
    
    this.selector = selector;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec putSelectorItem(String key, String selectorItem) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec sessionAffinity(String sessionAffinity) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec sessionAffinityConfig(DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecSessionAffinityConfig sessionAffinityConfig) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecSessionAffinityConfig getSessionAffinityConfig() {
    return sessionAffinityConfig;
  }


  public void setSessionAffinityConfig(DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpecSessionAffinityConfig sessionAffinityConfig) {
    this.sessionAffinityConfig = sessionAffinityConfig;
  }


  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec topologyKeys(List<String> topologyKeys) {
    
    this.topologyKeys = topologyKeys;
    return this;
  }

  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec addTopologyKeysItem(String topologyKeysItem) {
  ...
  **/
  ...
  public DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec type(String type) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class DomainGpugroupGpugroupV1AutoScalerSpecServiceTemplateSpec {\n");
